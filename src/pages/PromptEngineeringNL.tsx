    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8 bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
          <CardContent className="p-6">
            ...
            <p className="text-blue-800 mb-4">
              ...
              oefeningen, praktische voorbeelden en stap-voor-stap begeleiding.
            </p>
            <div className="flex flex-wrap gap-2">
              <Badge className="bg-green-100 text-green-800">🎯 8 Interactieve Oefeningen</Badge>
              <Badge className="bg-blue-100 text-blue-800">📚 3 Complete Modules</Badge>
              <Badge className="bg-purple-100 text-purple-800">🧠 Praktische Frameworks</Badge>
        ...
        <Card className="mt-8 bg-gradient-to-r from-green-50 to-blue-50 border-green-200">
          <CardContent className="p-6">
            <h3 className="font-bold text-green-900 mb-3">🇳🇱 Nederlandse Leer Tips</h3>
            <div className="grid md:grid-cols-2 gap-4 text-green-800">
              <div>
                <h4 className="font-semibold mb-2">Voor Beter Leren:</h4>
                <ul className="space-y-1 text-sm">
                  <li>• Start met Module 1: Fundamenten voor een sterke basis</li>
                  <li>• Oefen regelmatig met de interactieve oefeningen</li>
                  <li>• Gebruik de kleurgecodeerde prompt componenten</li>
                  <li>• Experimenteer met verschillende prompt structuren</li>
                  <li>• Pas geleerde technieken toe in praktijksituaties</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Nederlandse AI Tools:</h4>
                <ul className="space-y-1 text-sm">
                  ...
                  <li>• Deel kennis met de Nederlandse AI community</li>
                </ul>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mt-8 bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200">
          <CardContent className="p-6">
            <h3 className="font-bold text-indigo-900 mb-3">💡 Platform Mogelijkheden</h3>
            <div className="grid md:grid-cols-2 gap-4 text-indigo-800">
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  ...
                  <li>• Verschillende leerformaten (praktisch, analyse, creatief)</li>
                  <li>• Insluitbare oefeningen voor externe integratie</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-1 text-sm">
                  ...
                  <li>• Community functies en gedeelde prompts</li>
                  <li>• Geavanceerde analytics en leerinzichten</li>
                  <li>• Certificering en voortgangsbadges</li>
                </ul>
              </div>
            </div>
          </CardContent>
